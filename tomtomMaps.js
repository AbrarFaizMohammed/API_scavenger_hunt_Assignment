...
var map = tt.map({
  ...
  const apiKey = 'VzJMrtMY5GWj1EJHXHCYoF3rfLmA1Mau';
  const waypoints = '37.7790262,-122.419906:34.0536909,-118.242766'; // Example coordinates
...
.then(data => {
  if (data.routes && data.routes.length > 0) {
    ...
    if (route.legs[0] && route.legs[0].points) {
      ...
      map2.fitBounds(new tt.LngLatBounds(coordinates), { padding: 100 });
    } else {
